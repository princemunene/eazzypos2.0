...
var param = '';
var url = "http://"+window.localStorage.getItem('server')+"/eazzypos/www/bridge.php?id=5&param="+param+"&database="+database;
...
function todaysales(){
    ...
    $.ajax({
    url:'http://'+window.localStorage.getItem('server')+'/eazzypos/www/report.php?database='+database,
...
function tickaccess(a,b){
    ...
    $.ajax({
    url:'http://'+window.localStorage.getItem('server')+'/eazzypos/www/data.php?database='+database,
...
$( ".datepicker" ).datepicker()
    $.ajax({
      url:"http://"+window.localStorage.getItem('server')+"/eazzypos/www/bridge.php?id=16&type=Expense&database="+database,
      data:{},
      success:function(result){
        ...
        var url = "http://"+window.localStorage.getItem('server')+"/eazzypos/www/bridge.php?id=17&subcat=Bank&database="+database;
        $.getJSON(url, function(result) {
            console.log(result);
            for (var i=0;i<result.length;i++){
         ...
         var url = "http://"+window.localStorage.getItem('server')+"/eazzypos/www/bridge.php?id=20&database="+database;
        $.getJSON(url, function(result) {
            console.log(result);
            for (var i=0;i<result.length;i++){
...
myApp.onPageInit('refunds', function (page) {
 $('#myInput').focus();
 var param = '';
	var url = "http://"+window.localStorage.getItem('server')+"/eazzypos/www/bridge.php?id=6&param="+param+"&database="+database;
        $.getJSON(url, function(result) {
            console.log(result);
            $("#myUL").html('');
        ...
        var enterKey = 13;
	        if (e.which == enterKey&&param!=''){
	        		var url = "http://"+window.localStorage.getItem('server')+"/eazzypos/www/bridge.php?id=7&rcptno="+param+"&database="+database;
			        $.getJSON(url, function(result) {
...
myApp.onPageInit('addcontrol', function (page) {
	    ...
	    var itemcode = window.localStorage.getItem('controlcode');
			$.ajax({
			url:'http://'+window.localStorage.getItem('server')+'/eazzypos/www/bridge.php?database='+database,
...
$( ".datepicker" ).datepicker();
      ...
      success:function(result){
        ...
        /*
        var url = "http://"+window.localStorage.getItem('server')+"/eazzypos/www/bridge.php?id=16&type=Expense&database="+database;
        $.getJSON(url, function(result) {
            console.log(result);
            for (var i=0;i<result.length;i++){
...
myApp.onPageInit('settings', function (page) {
        var url = "http://"+window.localStorage.getItem('server')+"/eazzypos/www/bridge.php?id=18&database="+database;
        $.getJSON(url, function(result) {
            console.log(result);
            for (var i=0;i<result.length;i++){
        ...
        var url = "http://"+window.localStorage.getItem('server')+"/eazzypos/www/bridge.php?id=19&database="+database;
        $.getJSON(url, function(result) {
            console.log(result);
...
function updateitems(){
		var url = "http://"+window.localStorage.getItem('server')+"/eazzypos/www/bridge.php?id=4&database="+database;
        $.getJSON(url, function(result) {
...
myApp.onPageInit('newitem', function (page) {
      ...
      $('#uploadphoto').attr('action', 'http://'+window.localStorage.getItem('server')+'/eazzypos/www/upload.php?database='+database);
...
myApp.onPageInit('creditnote', function (page) {
         	...
         	tot=0;
         	var url = "http://"+window.localStorage.getItem('server')+"/eazzypos/www/bridge.php?id=8&saleno="+saleno+"&database="+database;
        	$.getJSON(url, function(result) {
            console.log(result);
            //reprint receipt
